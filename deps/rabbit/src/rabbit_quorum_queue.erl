...
ra_machine_config(Q) when ?is_amqqueue(Q) ->
    ...
    #{name => Name,
      ...
      dead_letter_handling => dead_letter_handling(DeadLetterStrategy, Q),
...
%%----------------------------------------------------------------------------
dead_letter_handling(Stategy, Q) ->
    ...
    case init_dlx(DLXName, Q) of
        ...
        DLX ->
            ...
            dead_letter_handling0(Stategy, MFA)
    end.
...
dead_letter_handling0(undefined, MFA) ->
    {at_least_once, MFA};
dead_letter_handling0(<<"at-least-once">>, MFA) ->
    {at_least_once, MFA};
dead_letter_handling0(<<"at-most-once">>, MFA) ->
    {at_most_once, MFA}.
