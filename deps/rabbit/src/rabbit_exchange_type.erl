...
-callback route(rabbit_types:exchange(), rabbit_types:delivery(), [rabbit_exchange:route_opt()]) ->
    [rabbit_types:binding_destination() | {rabbit_amqqueue:name(), rabbit_types:binding_key()}].
